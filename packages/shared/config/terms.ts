...
Welcome to Groot! These Terms and Conditions ("Terms") govern your use of the Groot service at ia.lenylvt.cc (the "Service"). By accessing or using our Service, you agree to be bound by these Terms. If you do not agree with any part of these Terms, you must not use the Service.
...
- "Service" refers to the Groot platform at ia.lenylvt.cc, including all related software, applications, and services operated by leny.
...
When you are signed in, conversations are stored server-side in Cloudflare D1, associated with your account. You can delete threads from the app. We do not sell your data.
...
The outputs from Groot are generated using large language models (xAI Grok). These outputs might not always be accurate, complete, or up-to-date. You acknowledge that all outputs and responses are provided on an "as is" basis. The Service is not a substitute for professional advice (legal, medical, financial, or otherwise). Always seek the guidance of qualified professionals before making decisions based on the outputs generated by the Service.

### 8. Intellectual Property

- Ownership: leny and its licensors own all rights, title, and interest in and to the Service, including any underlying software, technology, and content (excluding User Content).
- User Content License: By submitting or transmitting any content ("User Content") to the Service, you grant leny a non-exclusive, worldwide, royalty-free license to store, display, process, and use your User Content in connection with providing and improving the Service.
- Trademarks: All trademarks, service marks, logos, and trade names belonging to Groot are trademarks of leny.
...
In no event shall leny, its affiliates, or its licensors be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses, resulting from:

- Your use or inability to use the Service.
- Any unauthorized access to or use of our servers.
- Any bugs, viruses, or other harmful code.

In no event will leny's total liability exceed one hundred US dollars (USD $100).

### 12. Indemnification

You agree to indemnify, defend, and hold harmless leny, its affiliates, and its licensors from and against any and all claims, damages, losses, liabilities, costs, and expenses arising from or related to your use of the Service or any violation of these Terms.
...
- Entire Agreement: These Terms constitute the entire agreement between you and leny regarding your use of the Service.
